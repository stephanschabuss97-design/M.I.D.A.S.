...
const CORE_ASSETS = [
  ...
  toUrl('app/modules/vitals-stack/activity/index.js?v=21'),
  toUrl('app/supabase/index.js?v=21'),
  toUrl('app/supabase/core/state.js?v=21'),
  toUrl('app/supabase/core/client.js?v=21'),
  toUrl('app/supabase/core/http.js?v=21'),
  toUrl('app/supabase/auth/index.js?v=21'),
  toUrl('app/supabase/auth/core.js?v=21'),
  toUrl('app/supabase/auth/ui.js?v=21'),
  toUrl('app/supabase/auth/guard.js?v=21'),
  toUrl('app/supabase/realtime/index.js?v=21'),
  toUrl('app/supabase/api/intake.js?v=21'),
  toUrl('app/supabase/api/vitals.js?v=21'),
  toUrl('app/supabase/api/notes.js?v=21'),
  toUrl('app/supabase/api/select.js?v=21'),
  toUrl('app/supabase/api/push.js?v=21'),
  toUrl('app/supabase/api/system-comments.js?v=21'),
  toUrl('app/supabase/api/trendpilot.js?v=21'),
  toUrl('app/supabase/api/reports.js?v=21'),
  ...
  toUrl('assets/js/boot-auth.js?v=21'),
  toUrl('app/modules/doctor-stack/charts/index.js?v=21'),
  toUrl('assets/js/main.js?v=21'),
