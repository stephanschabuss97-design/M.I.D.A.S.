...
const activityV2ProductLifecycle = Object.freeze({
  ...
  preflightSessionCommit() {
    if (arguments.length !== 0) {
      throw new Error('Activity V2 preflight does not accept payloads.');
    }
    if (!activityV2ProductController) return null;
    return activityV2ProductController.preflightSessionCommit();
  }
});
