...
# MIDAS Legacy Changelog v0.1-v1.8 and Unreleased

> Historisches, nicht normatives Changelog-Archiv. Der aktuelle
> Änderungsvertrag steht im [Root-Changelog](../../../CHANGELOG.md), der
> Release-Vertrag in der [Release-Readiness](../../qa/release-readiness.md).

## Archivvertrag

- Archiviert am: `2026-07-21`
- Primärquelle: bisheriger Root `CHANGELOG.md`, vollständig und in
  unveränderter Quellreihenfolge
- Vergleichsquelle:
  `C:\\Users\\steph\\Projekte\\Backup\\Old\\CHANGELOG.md`
- Der Primärsnapshot enthält `69` H2-Blöcke.
- Doppelte, undatierte oder chronologisch verschobene Blöcke bleiben als
  historische Quellenmerkmale erhalten.
- Historische Schreibweisen und vorhandene Encoding-Schäden werden nicht
  still korrigiert.

## Blockweiser Abgleich

- `62` Blöcke sind zwischen Root und Backup exakt gleich und werden daher
  nicht doppelt eingebettet.
- Nur im Root vorhanden: `Unreleased`, `v1.7.6`, `v1.8.0`, `v1.8.1`
  sowie die zwei eigenständigen `v1.8.2`-Blöcke.
- `v1.5.4` weicht zwischen beiden Quellen ab. Der Backup-Block wird deshalb
  nach dem vollständigen Root-Snapshot separat und mit Provenienz erhalten.
- Es existiert kein Block, der ausschließlich im Backup vorkommt.

## Primärsnapshot - Root-Changelog

<!-- BEGIN PRIMARY SOURCE: CHANGELOG.md -->
...
<!-- END PRIMARY SOURCE: CHANGELOG.md -->

## Abweichender Backup-Block - v1.5.4

<!-- BEGIN SUPPLEMENT: Backup/Old/CHANGELOG.md lines 317-324 -->
...
<!-- END SUPPLEMENT: Backup/Old/CHANGELOG.md lines 317-324 -->
